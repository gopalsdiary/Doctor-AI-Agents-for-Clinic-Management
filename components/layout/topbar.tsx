      ...
      <div className="flex items-center gap-3">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56 rounded-2xl p-2 border-slate-200/60 shadow-xl">
            ...
            <DropdownMenuItem onSelect={(event) => { event.preventDefault(); router.push('/app/profile'); }} className="rounded-xl px-3 py-2 text-sm font-semibold focus:bg-teal-50 focus:text-teal-700 cursor-pointer">Profile</DropdownMenuItem>
            <DropdownMenuItem onSelect={(event) => { event.preventDefault(); router.push('/app/settings'); }} className="rounded-xl px-3 py-2 text-sm font-semibold focus:bg-teal-50 focus:text-teal-700 cursor-pointer">Settings</DropdownMenuItem>
